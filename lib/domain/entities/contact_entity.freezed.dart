...
class _$ContactDataCopyWithImpl<$Res, $Val extends ContactData>
  ...
  $Res call({
    ...
    Object? industry_sector = freezed,
    ...
    return _then(_value.copyWith(
      ...
      industry_sector: freezed == industry_sector
          ? _value.industry_sector
          : industry_sector // ignore: cast_nullable_to_non_nullable
              as String?,
...
class _$ContactDataImpl implements _ContactData {
  ...
  @override
  String toString() {
    return 'ContactData(user_id: $user_id, first_name: $first_name, last_name: $last_name, phone: $phone, company: $company, position: $position, email: $email, profile_image: $profile_image, user_interest: $user_interest, industry_sector: $industry_sector, attendee_id: $attendee_id)';
  }
