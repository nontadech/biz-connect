...
abstract class $TicketCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<TicketData> tickets});
}
...
class _$TicketImpl implements _Ticket {
  const _$TicketImpl({final List<TicketData> tickets = const []})
      : _tickets = tickets;
...
abstract class _Ticket implements Ticket {
  const factory _Ticket({final List<TicketData> tickets}) = _$TicketImpl;
